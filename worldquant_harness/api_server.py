"""REST API server for worldquant-harness.
...
启动: DEEPSEEK_API_KEY=sk-xxx python -m worldquant_harness --transport http --port 8003
"""
...
_cors_origins = os.environ.get("WORLDQUANT_HARNESS_CORS_ORIGINS", "*")
_cors_list = [o.strip() for o in _cors_origins.split(",") if o.strip()]

app = FastAPI(
    title="worldquant-harness API",
    version="2.8.0",
    description="worldquant-harness — Agent-Native 因子研究平台。AI Agent 通过本 API 自主完成因子设计、回测、评分、诊断、反过拟合检测和 WQ BRAIN 提交。",
    docs_url=None,
    redoc_url=None,
