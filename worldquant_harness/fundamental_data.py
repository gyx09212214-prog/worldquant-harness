...
class FundamentalDataFetcher:
    ...
    def fetch_fundamentals(
        ...
        from .market_data import CACHE_ONLY, HAS_BAOSTOCK, _baostock_login, _baostock_logout, _bs_lock
        ...
        if to_fetch:
            ...
            elif not HAS_BAOSTOCK:
                logger.warning("baostock unavailable; returning market data without uncached fundamental enrichment")
            else:
                with _bs_lock:
                    _baostock_login()
                    try:
    ...
    def fetch_dividend_data(
        ...
        if to_fetch_codes:
            if CACHE_ONLY:
                ...
                logger.warning("baostock unavailable; returning market data without uncached dividend enrichment")
            else:
                with _bs_lock:
                    _baostock_login()
                    try:
