...
MAX_ACTIVE_TASKS = int(os.environ.get("WORLDQUANT_HARNESS_MAX_ACTIVE_TASKS", "100"))
MAX_TOTAL_TASKS = int(os.environ.get("WORLDQUANT_HARNESS_MAX_TOTAL_TASKS", "10000"))
TASK_TTL_SECONDS = int(os.environ.get("WORLDQUANT_HARNESS_TASK_TTL", "3600"))
TASK_TIMEOUT_SECONDS = int(os.environ.get("WORLDQUANT_HARNESS_TASK_TIMEOUT", "600"))
SSE_TIMEOUT_SECONDS = int(os.environ.get("WORLDQUANT_HARNESS_SSE_TIMEOUT", "300"))
MAX_SSE_CONNECTIONS = int(os.environ.get("WORLDQUANT_HARNESS_MAX_SSE", "1000"))
RATE_LIMIT_PER_MINUTE = int(os.environ.get("WORLDQUANT_HARNESS_RATE_LIMIT", "50"))
MAX_PROMPT_LENGTH = int(os.environ.get("WORLDQUANT_HARNESS_MAX_PROMPT_LEN", "500"))
MAX_REPORT_FILES = int(os.environ.get("WORLDQUANT_HARNESS_MAX_REPORTS", "200"))
